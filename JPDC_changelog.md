...
- [x] **Accuracy 趨勢**：DASH ≥ Sync-Greedy >> FedBuff-FD >> Random-Async ✅ Exp 1 確認 (44.47 > 43.66 > 35.57 > 23.47 > 17.53)
- [x] **Wall-clock 趨勢**：DASH 在相同 wall-clock 下收斂更快 ✅ Exp 1 確認 (979s vs 3,079s, 3.14× speedup)
